...
/**
 * 运行以下类可以生成该程序所需的数据库记录： win.iot4yj.ch13.pipeline.example.RecordGenerator
 *
...
public class CaseRunner {
    ...
    public static void main(String[] args) throws IOException {
        ...
        dst = new DataSyncTask(config) {
            {
                System.setProperty("ftp.client.impl", "io.github.viscent.mtpattern.ch6.promise.example.FakeFTPUploader");
            }
    ...
    private static class FakeRecordSource implements RecordSource {
        ...
        public FakeRecordSource() throws IOException {
            this.gis = new GZIPInputStream(
                new BufferedInputStream(CaseRunner.class.getResourceAsStream("/data/ch13/subscriptions.csv.gz")));
