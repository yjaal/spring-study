...
public class DataSyncTask implements Runnable {
    ...
    protected Set<File> retrieveGeneratedFiles() {
        ...
        // 模拟生成本地文件
        File currDir = new File(Tools.getWorkingDir("../classes/io/github/viscent/mtpattern/ch6/promise/example"));
        Collections.addAll(files,
            Objects.requireNonNull(currDir.listFiles((dir, name) -> new File(dir, name).isFile() && name.endsWith(".class"))));
